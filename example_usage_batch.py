...
from treelstm import TreeLSTM, calculate_evaluation_orders, util
...
if __name__ == '__main__':
    ...
    batch_data = util.batch_tree_input([data, data])
    batch_data['labels'] = torch.cat( (data['labels'], data['labels']))
    print(data)
    print(batch_data)
    ...
    for n in range(3):
        ...
        h, c = model(
            batch_data['features'],
            batch_data['node_order'],
            batch_data['adjacency_list'],
            batch_data['edge_order']
        )
